...
if time.duration > 60:
    ...
    print("Your password took " + str(minutes) + " minute(s) and " + str(seconds) + " seconds to crack!")
else:
    seconds = round(time.duration, 2)
    print("Your password took " + str(seconds) + " seconds to crack!")
